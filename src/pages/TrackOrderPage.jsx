...
const statusStyles = {
  ...
  CANCELLED: 'bg-brand-50 text-[#0f2557] border-brand-200',
}
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 pb-16 sm:space-y-10">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-[0_16px_40px_rgba(11,31,58,0.06)] sm:p-8">
        ...
        {error && (
          <div className="mt-5 flex items-start gap-3 rounded-2xl border border-brand-200 bg-brand-50 px-4 py-3 text-sm text-[#0f2557]">
