    ...
    <div className="space-y-20 pb-10 w-full overflow-x-hidden">
      ...
      <section className="space-y-8 w-full overflow-hidden">
        ...
        {promoProducts.map((product, index) => (
          ...
          <div
            key={product.id}
            className={`group relative flex flex-col justify-between min-h-[320px] sm:min-h-[240px] overflow-hidden rounded-3xl border border-white/60 bg-gradient-to-br ${promoStyles[index % promoStyles.length]} p-6 shadow-[0_8px_30px_rgba(11,31,58,0.05)] backdrop-blur-md transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(11,31,58,0.12)]`}
          >
            ...
            <div className="relative z-10 flex flex-1 flex-col sm:flex-row gap-4 sm:gap-6 items-center">
              ...
              {/* Image */}
              <div className="relative w-full sm:w-[200px] lg:w-[300px] flex-shrink-0 flex items-center justify-center h-[140px] sm:h-[180px] lg:h-[200px]">
