...
export default function NotFound() {
  return (
    <div className="relative flex min-h-[80vh] flex-col items-center justify-center overflow-hidden px-4 py-10 text-center">
      {/* Decorations */}
      <div className="absolute -right-32 -top-32 h-80 w-80 rounded-full bg-[#0f2557]/10 blur-3xl" />
      <div className="absolute -bottom-32 -left-32 h-80 w-80 rounded-full bg-blue-400/10 blur-3xl" />
      <Sparkles className="absolute right-12 top-12 h-6 w-6 text-[#0f2557]/30" />
      ...
      <div className="relative">
        <div className="mb-6 inline-flex">
          <div className="relative">
            ...
            <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-[#0f2557] to-[#1a3a8a] text-white shadow-xl shadow-[#0f2557]/30 sm:h-28 sm:w-28">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Link
            to="/"
            className="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#0f2557] to-[#1a3a8a] px-6 py-3 text-sm font-bold text-white shadow-lg shadow-[#0f2557]/25 transition-all duration-200 hover:scale-[1.03] hover:shadow-xl hover:shadow-[#0f2557]/30 active:scale-[0.98]"
          >
            <Home size={16} />
            Retour à l'accueil
          </Link>
          <Link
            to="/catalogue"
            className="group inline-flex items-center gap-2 rounded-xl border-2 border-slate-200 bg-white px-6 py-3 text-sm font-bold text-[#0f2557] transition-all duration-200 hover:scale-[1.03] hover:border-[#0f2557] hover:text-[#0f2557] active:scale-[0.98]"
          >
            <Search size={16} />
