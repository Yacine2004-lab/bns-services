    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#fafbfd] via-white to-[#f5f8fc] px-6 py-12">
        <div className="w-full max-w-md text-center space-y-6">
          ...
          <h2 className="text-xl font-black text-[#0B1F3A]">Lien invalide</h2>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-11 py-2.5 rounded-xl border border-gray-200 focus:border-[#F5A623] focus:ring-2 focus:ring-[#F5A623]/20 outline-none transition-all duration-200 text-sm"
                    />
                    <button
                      type="button"
