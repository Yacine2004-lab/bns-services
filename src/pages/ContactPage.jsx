  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <div className="text-center max-w-2xl mx-auto">
        <h1 className="text-4xl font-black tracking-tight text-[#0f2557] sm:text-5xl">
          Contactez-nous
        </h1>
      ...
      <div className="grid gap-8 lg:grid-cols-5">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-6">
            <h2 className="text-lg font-bold text-[#0f2557]">Nos coordonnées</h2>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="text-sm font-bold text-[#0f2557]">WhatsApp</p>
              ...
              <div className="flex items-start gap-3 rounded-xl p-3">
                ...
                <div>
                  <p className="text-sm font-bold text-[#0f2557]">Email</p>
                  <p className="text-xs text-slate-500">contact@bnsservices.sn</p>
                </div>
              </div>

              <div className="flex items-start gap-3 rounded-xl p-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-50 text-[#e87722] flex-shrink-0">
                  <MapPin size={20} />
                </div>
                <div>
                  <p className="text-sm font-bold text-[#0f2557]">Adresse</p>
              ...
              <div className="flex items-start gap-3 rounded-xl p-3">
                ...
                <div>
                  <p className="text-sm font-bold text-[#0f2557]">Téléphone</p>
                  <p className="text-xs text-slate-500">+221 78 445 95 10</p>
                </div>
              </div>
            </div>
        ...
        <div className="lg:col-span-3">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            {!sent ? (
              <>
                <h2 className="text-lg font-bold text-[#0f2557] mb-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm outline-none focus:border-[#e87722] focus:ring-2 focus:ring-[#e87722]/20"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-[#0f2557] mb-1.5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm outline-none focus:border-[#e87722] focus:ring-2 focus:ring-[#e87722]/20 resize-y"
                    />
                  </div>
                  <button
                    type="submit"
                    className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-[#e87722] py-3 text-sm font-bold text-[#0f2557] transition hover:bg-[#e87722]"
                  >
                    <Send size={16} />
              ...
              <div className="text-center space-y-4 py-8">
                ...
                <h3 className="text-xl font-bold text-[#0f2557]">Message envoyé !</h3>
