...
export default function Toast() {
  ...
  return (
    <div className="fixed top-20 right-4 sm:right-6 z-50 max-w-sm sm:max-w-md w-full animate-in fade-in slide-in-from-top-4 duration-300">
      <div className="flex items-center gap-3.5 rounded-2xl border border-white/40 bg-[#0B1F3A]/95 p-4 text-white shadow-[0_20px_50px_rgba(11,31,58,0.35)] backdrop-blur-xl">
        {toast.product?.image ? (
          <img
          ...
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#f9b448] to-[#f5a623] text-[#0B1F3A] flex-shrink-0">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <button
            ...
            className="inline-flex items-center gap-1 rounded-xl bg-white/15 px-3 py-1.5 text-xs font-bold text-white hover:bg-[#f5a623] hover:text-[#0B1F3A] transition-all"
          >
            <ShoppingBag size={13} />
            <span>Panier</span>
          </button>
